...
SmsCodeModel smsCodeModelFromJson(String str) =>
    SmsCodeModel.fromJson(json.decode(str));
...
class SmsCodeModel {
  ...
  factory SmsCodeModel.fromJson(Map<String, dynamic> json) =>
      _$SmsCodeModelFromJson(json);
...
class Headers {
  ...
  Headers({required this.userAgent});
