...
WarehouseModel _$WarehouseModelFromJson(
  Map<String, dynamic> json,
) => WarehouseModel(
  advType: json['adv_type'] as String,
  serviceTypeId: (json['service_type_id'] as num).toInt(),
  toLocation: ToLocation.fromJson(json['to_location'] as Map<String, dynamic>),
  price: (json['price'] as num).toInt(),
  details: DetailsWarehouse.fromJson(json['details'] as Map<String, dynamic>),
...
DetailsWarehouse _$DetailsWarehouseFromJson(Map<String, dynamic> json) =>
    DetailsWarehouse(area: json['area'] as String);
