...
TransportSpecialistsModel transportSpecialistsModelFromJson(String str) =>
    TransportSpecialistsModel.fromJson(json.decode(str));

String transportSpecialistsModelToJson(TransportSpecialistsModel data) =>
...
class TransportSpecialistsModel {
  ...
  factory TransportSpecialistsModel.fromJson(Map<String, dynamic> json) =>
      _$TransportSpecialistsModelFromJson(json);
